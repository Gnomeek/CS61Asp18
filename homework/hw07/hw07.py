...
class MissManners:
    ...
    def ask(self, message, *args):
        ...
        if not message.startswith(magic_word):
            ...
            rest_message = message[7:]
            if not hasattr(self.obj, rest_message):
                return 'Thanks for asking, but I know not how to {0}.'.format(rest_message)
            else:
                return getattr(self.obj, rest_message)(*args)
